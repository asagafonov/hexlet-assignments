...
hash.each_key { |key, _value| puts("Key: #{key}") }
hash.each_value { |_key, value| puts("Value: #{value}") }
...
hash.reject { |_key, value| value == 1 } # { baz: 2, bar: 3 }
hash.reject { |_key, value| value == 1 } # { baz: 2, bar: 3 }
